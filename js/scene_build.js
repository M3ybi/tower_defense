        ...
        setTimeout(function () {
            ...
            for (let i = 0; i < targets; i++) {
                if (document.getElementById(k) != null) {
                    ...
                    document.getElementById(k).parentNode.removeChild(document.getElementById(k));
                }
                k++;
                document.getElementById(rings_id).parentNode.removeChild(document.getElementById(rings_id));
                rings_id++;
            }
